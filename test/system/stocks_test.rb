...
class StocksTest < ApplicationSystemTestCase
  ...
  test "should create stock" do
    ...
    fill_in "Change", with: @stock.change
    fill_in "Change percent", with: @stock.change_percent
    fill_in "Change percent s", with: @stock.change_percent_s
    fill_in "Company code", with: @stock.company_code
    fill_in "Company name", with: @stock.company_name
    fill_in "Latest price", with: @stock.latest_price
